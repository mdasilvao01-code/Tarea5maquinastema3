...
Vagrant.configure("2") do |config|
  ...
  config.vm.define "SERVERNTS" do |servernts|
  ...
  config.vm.define "MARIADB" do |mariadb|
    ...
    mariadb.vm.network "private_network", ip:"192.168.20.50", virtualbox__intnet: "redBASEDEDATOS"
    mariadb.vm.provision "shell", path: "aprov_mariadb.sh"
  end
